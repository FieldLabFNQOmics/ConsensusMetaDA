...
Below the core functionality of ConsensusMetaDA as well as how to plot results using the OTUs_plots function.
...
In addition, each of the 5 plots can be plotted individually using the ```OTUs_plots``` function. See ```?OTUs_plots``` for description, which provides wrappers for 5 different plots. Next we will plot each of these using the example data.
